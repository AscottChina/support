...
<head>
    ...
    <title>酒店电子设备使用指南</title>
    <link rel="vvvvv" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
...
<body>
    ...
    <div class="container">
        ...
        <div class="devices-container">
            ...
            <div class="device-card" onclick="openModal('电动窗帘', 'https://www.youtube.com/embed/dQw4w9WgXcQ', '学习如何操作电动窗帘、设置定时开关和调节透光度。视频将展示遥控器使用方法和智能场景联动功能。')">
